...
const BlogIndex = () => {
  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        <title>Blog Céramique Paris - Actualités Atelier Vents et Courbes Le Pré-Saint-Gervais</title>
        <meta name="description" content="Blog céramique de l'Atelier Vents et Courbes au Pré-Saint-Gervais : actualités, conseils tournage, techniques modelage, nouveautés formation céramique Paris." />
        <link rel="canonical" href="https://ventsetcourbes.org/blog" />
        <meta property="og:title" content="Blog Céramique Paris - Actualités Atelier Vents et Courbes" />
        <meta property="og:description" content="Blog céramique de l'Atelier Vents et Courbes au Pré-Saint-Gervais : actualités, conseils tournage, techniques modelage." />
        <meta property="og:url" content="https://ventsetcourbes.org/blog" />
      </Helmet>
