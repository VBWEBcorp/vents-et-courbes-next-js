...
const BlogPostDetail = () => {
  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        <title>{article.seo_title || `Céramique ${article.title} - Blog Atelier Vents et Courbes Le Pré-Saint-Gervais`}</title>
        <meta name="description" content={article.seo_description || `Céramique : ${article.excerpt} - Article du blog de l'Atelier Vents et Courbes au Pré-Saint-Gervais, centre de formation céramique certifié Qualiopi.`} />
        <link rel="canonical" href={`https://site-vents-et-courbe-mshv.bolt.host/blog/${article.slug}`} />
        <link rel="canonical" href={`https://ventsetcourbes.org/blog/${article.slug}`} />
        <meta property="og:title" content={`Céramique ${article.title} - Blog Atelier Vents et Courbes`} />
        <meta property="og:description" content={article.excerpt} />
        <meta property="og:url" content={`https://ventsetcourbes.org/blog/${article.slug}`} />
