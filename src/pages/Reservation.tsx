      ...
      <div className="min-h-screen">
        ...
        <div className="pt-32 pb-16 px-6 text-center">
          ...
          <div className="space-y-2">
            <Link to="/cours" className="block text-primary-400 hover:text-primary-500">
              Retour aux cours
            </Link>
            <Link to="/stages" className="block text-primary-400 hover:text-primary-500">
              Retour aux stages
            </Link>
          </div>
        </div>
